        ...
        @foreach($article as $key => $art)
            <div class="preview_news">
                ...
                <article>
                    ...
                    @if ($art['thumbnail'] != '')
                        <img src="{{ $art['thumbnail'] }}" class="img-responsive">
                    @endif
        ...
        @endforeach
            <div class="related_news">
                ...
                @foreach($related as $key => $rel)
                    <article class="row @if($native == 'Arabic' || $native == 'Urdu' || $native == 'Dhivehi'){{ 'text-right' }} @endif">
                        @if ($rel['thumbnail'] != '')
                        <div class="col-md-3">
                            <img src="{{ $rel['thumbnail'] }}" class="thumbnail img-responsive">
                        </div>
                        <div class="col-md-9">
                        @else
                        <div class="col-md-12">
